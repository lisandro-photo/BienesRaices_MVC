<fieldset>
            ...
            <!--El "name" trabaja en conjunto con el method="GET" y es aconsejable repetir el mismo que colocamos en el id-->
            ...
            <!--Type "file" habilita el explorador para buscar y seleccionar un archivo a subir-->
